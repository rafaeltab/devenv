use crate::{domain::aggregates::tmux::{
...
pub trait TmuxClientRepository {
    fn get_clients(&self, filter: Option<TmuxFilterNode>, include: ClientIncludeFields) -> Vec<TmuxClient>;
    fn switch_client(&self, client: &TmuxClient, target: SwitchClientTarget) -> TmuxClient;
}
